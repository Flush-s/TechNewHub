                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="is_admin" class="inline-flex items-center">
                                <input type="checkbox" name="is_admin" id="is_admin" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ $user->is_admin ? 'checked' : '' }}>
